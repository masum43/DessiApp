...
public class Api {
    ...
    final static public String BASE_URL = "https://www.desiiapp.com/api";
    ...
    final static public String FORGOT_PASS = BASE_URL + "/forgetpassword";
    final static public String RESET_PASS = BASE_URL + "/changepassword";
